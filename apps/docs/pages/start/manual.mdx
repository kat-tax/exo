...
:::warning
Make sure to install peer dependencies noted on the component page if needed.
:::
...
:::info
This step is optional, but allows additional functionality like themes.
:::

Follow the instructions at: https://unistyl.es/start/setup
